...
<div id="jjes-main-area">
    <div class="es-admin-title"><?php echo __('Add Email Address','zem_emailsystem');?></div>
    <div class="jjes-content-area">
        <form id="jjes-saveform" method="post" action="<?php echo admin_url("admin.php?page=emailaddress&task=save"); ?>">
            <div class="jjes-field-wrapper">
                <div class="col-xs-4 col-md-3 jjes-title"><?php echo __('Email Group'); ?><font class="jjes-required">*</font></div>
            ...
            <div class="jjes-field-wrapper">
                <div class="col-xs-4 col-md-3 jjes-title"><?php echo __('Email address'); ?><font class="jjes-required">*</font></div>
                <div class="col-xs-8 col-md-9 jjes-value"><?php echo zemeshtml::text('emailaddress', isset(zememailsystem::$items[0]->emailaddress) ? zememailsystem::$items[0]->emailaddress : '', array('class' => 'inputbox', 'data-validation' => 'required')) ?></div>
            </div>
            <div class="jjes-field-wrapper">
            ...
            <div class="jjes-submit-wrapper">
                <?php echo zemeshtml::submit('save', __('Save Email Address','zem_emailsystem'), array('class' => 'button')); ?>
            </div>
        </form>
    </div>
</div>